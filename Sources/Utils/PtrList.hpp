...
#include "TypeTraits.hpp"      // maybe_add_const, iterator_category, difference_type
#include "ContainerUtils.hpp"  // reserveSpace, insertCopies, insertMultiple, removeCountAt
